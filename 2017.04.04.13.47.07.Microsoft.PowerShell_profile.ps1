...
Set-Alias   -scope global -name   usort         -value   "C:/Git/bin/sort.exe"
...
Set-Alias   -scope global -name   ugrep         -value   "C:/Git/bin/grep.exe"
...
function ensureDirectoryStructure { # {{{
    ...
    foreach( $d in $directoriesneeded ) { # {{{
        Write-Host -ForegroundColor magenta "$d"
